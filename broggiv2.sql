...
CREATE TABLE `afectats` (
  ...
  `tenir_tarjeta` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `alertants` (
  ...
  `tipus_alertant_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `incidencies` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `localitzacio` varchar(250) DEFAULT NULL,
  `num_incidencia` int(11) DEFAULT NULL,
  `telefon_alertant` int(15) DEFAULT NULL,
  ...
  `municipis_id` int(11) DEFAULT NULL,
  `tipus_incident_id` int(11) DEFAULT NULL,
  `estats_incidencia_id` int(11) DEFAULT NULL,
  `tipus_alertant_id` int(11) DEFAULT NULL,
  `alertants_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `incidencies_has_recursos` (
  ...
  `hora_acitvacio` time DEFAULT NULL,
